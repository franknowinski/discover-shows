...
ActiveRecord::Schema.define(version: 20160410023410) do
  ...
  add_index "upcoming_concerts", ["concert_id"], name: "index_upcoming_concerts_on_concert_id", using: :btree
  add_index "upcoming_concerts", ["user_id"], name: "index_upcoming_concerts_on_user_id", using: :btree
